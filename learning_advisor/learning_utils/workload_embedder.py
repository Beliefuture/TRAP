...
from heuristic_advisor.heuristic_utils.workload import Query

from .boo import BagOfOperators


class WorkloadEmbedder(object):
    def __init__(self, query_texts, representation_size,
                 database_connector, globally_index_candidates=None, retrieve_plans=False):
        self.STOPTOKENS = ["as",
                           "and",
                           "or",
                           "min",
...
class PlanEmbedder(WorkloadEmbedder):
    def __init__(self, query_texts, representation_size, database_connector, globally_index_candidates, without_indexes=False):
...
class PlanEmbedderLSIBOW(PlanEmbedder):
    def __init__(self, query_texts, representation_size, database_connector, globally_index_candidates, without_indexes=False):
        PlanEmbedder.__init__(self, query_texts, representation_size, database_connector, globally_index_candidates, without_indexes)
